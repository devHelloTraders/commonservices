package com.traders.common.appconfig.logging;
...
public final class LoggingUtils {
    ...
    public static void addLogstashTcpSocketAppender(LoggerContext context, String customFields, ConfigProperties.Logging.Logstash logstashProperties) {
    ...
    public static void addContextListener(LoggerContext context, String customFields, ConfigProperties.Logging properties) {
    ...
    private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
        private final ConfigProperties.Logging loggingProperties;
        private final String customFields;

        private LogbackLoggerContextListener(ConfigProperties.Logging loggingProperties, String customFields) {
